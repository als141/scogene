...
{\large\sffamily
\begin{tabular}{ll}
\textbf{申請者:} & 高橋創真（長岡技術科学大学大学院 修士1年）\\[0.3em]
\textbf{共同開発者:} & 若月耕紀（長岡技術科学大学大学院 修士1年）\\
& 小武壮太（長岡技術科学大学大学院 修士1年）\\
& 舛田　岳（新潟大学大学院 修士1年）\\
\end{tabular}
}
...
近年、LLMを活用した教育システムの研究が急速に進展している\,[6]。AIによる自動採点と個別最適化問題生成は、教育者の時間を「生徒と向き合う時間」に転換する本質的な解決策となり得る\,[7]。
...
高橋・若月・小武は長岡技術科学大学大学院 情報・経営システム工学分野 修士1年、舛田は新潟大学大学院 自然科学研究科 修士1年に所属する。全員が授業単位を取得済みであり、修士研究を抱えるのみである。研究室の指導教員との関係も良好で、未踏への応募についても容認されている。
...
\noindent\textbf{高橋 創真}：趣味は野球。小学3年から現在まで軟式野球部に所属し、地域ナイター杯で準優勝。厳しい練習を通じて培った粘り強さがプロジェクト推進の原動力。
\textbf{若月 耕紀}：実家が動物病院で犬9匹・猫6匹に囲まれて育った。言葉の通じない相手の裏側を想像する力が、マネジメントスキルの基盤。
\textbf{小武 壮太}：趣味はデザイン制作。技大祭の広報としてInstagram運用を担当。「相手の想いを翻訳する力」がUI/UX設計を支える。
\textbf{舛田 岳}：バレーボールでJOC秋田県選抜。映像制作を通じて「何を、どう見せれば伝わるか」を考える力を培った。
...
\begin{enumerate}[leftmargin=2em,label={[\arabic*]}]
  ...
  \item Emirtekin, E. (2025). Large Language Model-Powered Automated Assessment: A Systematic Review. \textit{Applied Sciences}, 15(10), 5683.
\end{enumerate}
\end{small}
