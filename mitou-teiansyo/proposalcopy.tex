...
{\small\sffamily 生徒の手書き答案をAIで解析し、間違え方や苦手を抽出し、それらを克服できる問題を\textbf{無限に}生成する。「問題生成」と「採点」のサイクルにより、これまでにない学習効果を実現する。}\par\vspace{3pt}
...
\textbf{採点「ScoGene」：}\url{https://scogene.vercel.app}
\end{graybox}
