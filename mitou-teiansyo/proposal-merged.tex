...
私は約20人の生徒を受け持ち、月ごとに統一模試結果や定期テスト結果、小テスト結果を見ながら個別に対応するが、20人全員の苦手を正確に把握し続けることは人間の記憶力では限界がある。しかも\textbf{単元が変わるたびに苦手な生徒が入れ替わる}。先月「方程式」で苦戦した生徒が今月は問題なく、代わりに別の生徒が「図形」で躓く---この動的なバラつきへの対応は5年の経験でも容易ではない。
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.6\textwidth]{mongene-compare.png}
...
しかし、2026年2月の受験期にモンジェネを使い込んだところ、\textbf{まだまだ足りない}と痛感した。難易度の調整ができない、出力は固定の3パターンのみ、そして何より---生徒一人ひとりの苦手が反映されていない。「生徒ごとの苦手が反映されている問題だったらいいな」という塾講師の声が聞こえてきた。これが本提案の出発点となった。
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{docs-cycle.png}
...
氏名 & 所属 & 担当 \\
\midrule
高橋創真 & \parbox[t]{3cm}{長岡技術科学大学\\大学院工学研究科\\情報・経営システム工学分野} & チームマネジメント、ユーザヒアリング、要件定義 \\[6pt]
若月耕紀 & \parbox[t]{3cm}{長岡技術科学大学\\大学院工学研究科\\情報・経営システム工学分野} & フロントエンド・バックエンド実装全般 \\[6pt]
小武壮太 & \parbox[t]{3cm}{長岡技術科学大学\\大学院工学研究科\\情報・経営システム工学分野} & UI/UXデザイン、システムデザイン \\[6pt]
舛田　岳 & \parbox[t]{3cm}{新潟大学\\大学院自然科学研究科\\電気情報工学専攻} & LLM・ML・インフラ/システム開発全般 \\
\bottomrule
\end{tabularx}
\end{footnotesize}
...
11月--12月 & 教師向けFBダッシュボード実装。完全習得学習フロー（マスタリー判定・苦手克服問題自動生成）の統合 \\
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.8\columnwidth]{mongene-ui.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\columnwidth]{docs-robocon.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\columnwidth]{docs-nutmeg.png}
...
これまで、グラフィックデザインを主軸に、イベントの広報物制作や空間演出のディレクションを行ってきた。現在はその知見をWeb領域へ拡張し、Figmaを用いたUI/UX設計や、生成AIを活用したフロントエンドのプロトタイピングを行っている。
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth,height=6cm,keepaspectratio]{docs-hobby-takahashi.png}
  \caption{地域ナイター杯で準優勝}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth,height=6cm,keepaspectratio]{docs-hobby-kotake.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\columnwidth,height=6cm,keepaspectratio]{docs-hobby-masuda.jpg}
  \caption{高校バレーボール部時代}
\end{figure}
